<nav class="navbar navbar-expand-lg sticky-top navbar-light bg-light shadow ">
    <div class="container">
        <a class="navbar-brand __logo-brand" href="{{ route('index') }}">EN-Shopping</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav ms-auto">
                ...
                <a class="nav-link __nav {{ request()->is('kategori') ? 'active' : '' }}" href="{{ route('kategori.landing') }}">Kategori Product</a>
            </div>
        </div>
    </div>
</nav>
